...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Lakon WEB | Jasa Pembuatan Custom Website</title>


    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('img/lakon-web/logo black back white.jpg') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('img/lakon-web/logo black back white.jpg') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('img/lakon-web/logo black back white.jpg') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('img/lakon-web/logo black back white.jpg') }}">
    <link rel="manifest" href="{{ asset('assets-lakonweb/assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ asset('img/lakon-web/logo black back white.jpg') }}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ asset('assets-lakonweb/assets/css/theme.css') }}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-5 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="{{ asset('img/lakon-web/logo-text-black-small.png') }}" height="24" alt="logo" /></a>
      ...
      <section style="padding-top: 7rem;">
        <div class="bg-holder" style="background-image:url({{ asset('assets-lakonweb/assets/img/hero/hero-bg.svg') }});">
        </div>
        <!--/.bg-holder-->
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
              ...
              <div class="text-center text-md-start"> <a class="btn btn-primary btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow" href="#!" role="button">Pelajari Lebih Lanjut</a>
                ...
                {{-- <a href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span class="btn btn-danger round-btn-lg rounded-circle me-3 danger-btn-shadow"> <img src="{{ asset('assets-lakonweb/assets/img/hero/play.svg') }}" width="15" alt="paly"/></span></a><span class="fw-medium">Play Demo</span>
      ...
      <section class="pt-5 pt-md-9" id="service">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="{{ asset('assets-lakonweb/assets/img/category/icon2.png') }}" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="{{ asset('assets-lakonweb/assets/img/category/icon3.png') }}" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="{{ asset('assets-lakonweb/assets/img/category/icon4.png') }}" width="75" alt="Service" />
      ...
      <section class="pt-5" id="destination">
        ...
        <div class="container">
          <div class="position-absolute start-100 bottom-0 translate-middle-x d-none d-xl-block ms-xl-n4"><img src="{{ asset('assets-lakonweb/assets/img/dest/shape.svg') }}" alt="destination" /></div>
          <div class="mb-7 text-center">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="{{ asset('assets-lakonweb/assets/img/dest/dest1.jpg') }}" alt="Rome, Italty" />
                <div class="card-body py-4 px-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="{{ asset('assets-lakonweb/assets/img/dest/navigation.svg') }}" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">10 Days Trip</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="{{ asset('assets-lakonweb/assets/img/dest/dest2.jpg') }}" alt="London, UK" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="{{ asset('assets-lakonweb/assets/img/dest/navigation.svg') }}" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">12 Days Trip</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="{{ asset('assets-lakonweb/assets/img/dest/dest3.jpg') }}" alt="Full Europe" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="{{ asset('assets-lakonweb/assets/img/dest/navigation.svg') }}" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">28 Days Trip</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-primary me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="{{ asset('assets-lakonweb/assets/img/steps/selection.svg') }}" width="22" alt="steps" /></div>
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-danger me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="{{ asset('assets-lakonweb/assets/img/steps/water-sport.svg') }}" width="22" alt="steps" /></div>
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-info me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="{{ asset('assets-lakonweb/assets/img/steps/taxi.svg') }}" width="22" alt="steps" /></div>
                <div class="flex-1">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-start">
              <div class="card position-relative shadow" style="max-width: 370px;">
                <div class="position-absolute z-index--1 me-10 me-xxl-0" style="right:-160px;top:-210px;"> <img src="{{ asset('assets-lakonweb/assets/img/steps/bg.png') }}" style="max-width:550px;" alt="shape" /></div>
                <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100" src="{{ asset('assets-lakonweb/assets/img/steps/booking-img.jpg') }}" alt="booking" />
                  <div>
                    <h5 class="fw-medium">Trip To Greece</h5>
                    <p class="fs--1 mb-3 fw-medium">14-29 June | by Robbin joseph</p>
                    <div class="icon-group mb-4"> <span class="btn icon-item"> <img src="{{ asset('assets-lakonweb/assets/img/steps/leaf.svg') }}" alt=""/></span><span class="btn icon-item"> <img src="{{ asset('assets-lakonweb/assets/img/steps/map.svg') }}" alt=""/></span><span class="btn icon-item"> <img src="{{ asset('assets-lakonweb/assets/img/steps/send.svg') }}" alt=""/></span>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center mt-n1"><img class="me-3" src="{{ asset('assets-lakonweb/assets/img/steps/building.svg') }}" width="18" alt="building" /><span class="fs--1 fw-medium">24 people going</span></div>
                      <div class="show-onhover position-relative">
                        <div class="card hideEl shadow position-absolute end-0 start-xl-50 bottom-100 translate-xl-middle-x ms-3" style="width: 260px;border-radius:18px;">
                          <div class="card-body py-3">
                            <div class="d-flex">
                              <div style="margin-right: 10px"> <img class="rounded-circle" src="{{ asset('assets-lakonweb/assets/img/steps/favorite-placeholder.png') }}" width="50" alt="favorite" /></div>
                              <div>
                        ...
                        <button class="btn"> <img src="{{ asset('assets-lakonweb/assets/img/steps/heart.svg') }}" width="20" alt="step" /></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="pe-7 ps-5 ps-lg-0">
                <div class="carousel slide carousel-fade position-static" id="testimonialIndicator" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item position-relative active">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="{{ asset('assets-lakonweb/assets/img/testimonial/author.png') }}" height="65" width="65" alt="" /></div>
                    ...
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="{{ asset('assets-lakonweb/assets/img/testimonial/author2.png') }}" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                    ...
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="{{ asset('assets-lakonweb/assets/img/testimonial/author3.png') }}" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                          <p class="fw-medium mb-4">&quot;On the Windows talking painted pasture yet its express parties use. Sure last upon he same as knew next. Of believed or diverted no.&quot;</p>
                  ...
                  <div class="carousel-navigation d-flex flex-column flex-between-center position-absolute end-0 top-lg-50 bottom-0 translate-middle-y z-index-1 me-3 me-lg-0" style="height:60px;width:20px;">
                    <button class="carousel-control-prev position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="prev"><img src="{{ asset('assets-lakonweb/assets/img/icons/up.svg') }}" width="16" alt="icon" /></button>
                    <button class="carousel-control-next position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="next"><img src="{{ asset('assets-lakonweb/assets/img/icons/down.svg') }}" width="16" alt="icon" /></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 flex-center">
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="{{ asset('assets-lakonweb/assets/img/partner/1.png') }}" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="{{ asset('assets-lakonweb/assets/img/partner/2.png') }}" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="{{ asset('assets-lakonweb/assets/img/partner/3.png') }}" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="{{ asset('assets-lakonweb/assets/img/partner/4.png') }}" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="{{ asset('assets-lakonweb/assets/img/partner/5.png') }}" alt="" /></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="pt-6">
        ...
        <div class="container">
          <div class="py-8 px-5 position-relative text-center" style="background-color: rgba(223, 215, 249, 0.199);border-radius: 129px 20px 20px 20px;">
            <div class="position-absolute start-100 top-0 translate-middle ms-md-n3 ms-n4 mt-3"> <img src="{{ asset('assets-lakonweb/assets/img/cta/send.png') }}" style="max-width:70px;" alt="send icon" /></div>
            <div class="position-absolute end-0 top-0 z-index--1"> <img src="{{ asset('assets-lakonweb/assets/img/cta/shape-bg2.png') }}" width="264" alt="cta shape" /></div>
            <div class="position-absolute start-0 bottom-0 ms-3 z-index--1 d-none d-sm-block"> <img src="{{ asset('assets-lakonweb/assets/img/cta/shape-bg1.png') }}" style="max-width: 340px;" alt="cta shape" /></div>
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-10">
                <h2 class="lh-1-7">Jangan ragu untuk menghubungi kami</h2>
                <h6 class="text-secondary mb-5">Jika anda merasa bingung dengan kebutuhan website yang anda inginkan atau<br>ingin konsultasi tanya jawab lebih lanjut, silakan menghubungi kami</h6>
                <div class="align-items-center w-lg-75 mx-auto">
                  <button class="btn btn-success btn-rounded fs--1" style="border-radius: 30px;"><i class="fab fa-whatsapp"> </i> Chat Whatsapp</button>
                </div>
                {{-- <form class="row g-3 align-items-center w-lg-75 mx-auto">
                  <div class="col-sm">
                    <div class="input-group-icon">
                      <input class="form-control form-little-squirrel-control" type="email" placeholder="Tuliskan E-mail anda" aria-label="email" /><img class="input-box-icon" src="{{ asset('assets-lakonweb/assets/img/cta/mail.svg') }}" width="17" alt="mail" />
                    </div>
                  </div>
      ...
      <section class="pb-0 pb-lg-4">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img class="mb-4" src="{{ asset('img/lakon-web/logo-text-black-small.png') }}" width="150" alt="jadoo" />
              <h6>Tunggu apa lagi?</h6>
              <p class="fs--1 text-secondary mb-0 fw-medium">Perluas jangkauan bisnis Anda, jadikan bisnis Anda sebagai bisnis modern yang mudah dijangkau semua orang di Indonesia.</p>
            </div>
            ...
            <div class="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
              <h4 class="footer-heading-color fw-bold font-sans-serif mb-3 mb-lg-4">Sosial Media</h4>
              ...
              <div class="d-flex align-items-center"> <a href="#!"> <img class="me-2" src="{{ asset('assets-lakonweb/assets/img/play-store.png') }}" alt="play store" /></a><a href="#!"> <img src="{{ asset('assets-lakonweb/assets/img/apple-store.png') }}" alt="apple store" /></a></div> --}}
            </div>
          </div>
        </div><!-- end of .container-->
      ...
      <div class="py-5 text-center">
        <p class="mb-0 text-secondary fs--1 fw-medium">All rights reserved | lakonweb @ 2022</p>
      </div>
    </main>
    <!-- ===============================================-->
    <!--    End of Main Content-->
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('assets-lakonweb/vendors/@popperjs/popper.min.js') }}"></script>
    <script src="{{ asset('assets-lakonweb/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets-lakonweb/vendors/is/is.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('assets-lakonweb/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('assets-lakonweb/assets/js/theme.js') }}"></script>
