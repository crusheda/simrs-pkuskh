...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Pelaporan /</span> Manajemen Resiko
</h4>
...
<div class="card card-action mb-5">
  ...
  <div class="card-header">
    <div class="card-action-title"><button class="btn btn-primary"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;Tambah</button></div>
