    ...
    <div class="col">
        <div class="card" style="width: 100%">
            <div class="card-header bg-dark text-white">
                ...
                <i class="fa-fw fas fa-heartbeat nav-icon text-danger">
        
                </i> Data Rawat Inap <span class="badge badge-danger" style="margin-top:4px">UPDATED</span>
        
                <kbd style="background-color: whitesmoke" class="text-dark pull-right">{{ $list['now'] }}</kbd>
    ...
    <div class="col">
        <div class="card" style="width: 100%">
            <div class="card-header bg-dark text-white">
                ...
                <i class="fa-fw fas fa-heart nav-icon text-info">
        
                </i> Rekapitulasi Data Kunjungan Rawat Jalan <span class="badge badge-info" style="margin-top:4px">KEMARIN</span>
        
                <kbd style="background-color: whitesmoke" class="text-dark pull-right">{{ $list['yest'] }}</kbd>
