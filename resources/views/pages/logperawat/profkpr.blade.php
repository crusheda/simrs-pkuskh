                        ...
                        <table id="tdkperawat" class="table table-striped display">
                            ...
                            <tbody style="text-transform: capitalize">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->tgl }}</td>
                                    <td>
                                        <a type="button" class="btn btn-info btn-sm" href="{{ route('profkpr.show', $item->queue) }}"><i class="fa-fw fas fa-search nav-icon"></i></a>
                                        <a type="button" class="btn btn-success btn-sm" href="{{ route('profkpr.edit', $item->queue) }}"><i class="fa-fw fas fa-edit nav-icon"></i></a>
