...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets-new/vendor/libs/toastr/toastr.css') }}" />
...
<body>
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
          <h6 class="alert-heading d-flex align-items-center fw-bold mb-1">Pesan Gagal!</h6>
          <p class="mb-0">Pastikan Anda memasukkan Username & Password dengan benar. Coba sekali lagi</p>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center" style="margin-bottom: 0rem">
              <a href="javascript:void(0);" class="app-brand-link gap-2">
                <span class="app-brand-logo demo">
                  <img src="{{ asset('css-landing/img/landing-logotext.png') }}" alt="" width="200px">
            ...
            <p class="mb-4">Sistem Informasi Manajemen Rumah Sakit PKU Muhammadiyah Sukoharjo</p>

            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
              <div class="mb-3">
                <label for="email" class="form-label">Username</label>
                <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan username anda" required autofocus>
              </div>
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('password') }}" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
  ...
  <script src="{{ asset('assets-new/vendor/libs/toastr/toastr.js') }}"></script>
  
  <!-- Page JS -->
  <script src="{{ asset('assets-new/js/ui-toasts.js') }}"></script>

  {{-- @if ($errors->has('name'))
    <center><strong>{{ $errors->first('name') }}</strong></center>
  @endif --}}
</body>
</html>
