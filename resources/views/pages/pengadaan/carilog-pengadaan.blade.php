    ...
    <div class="row">
        <div class="card" style="width: 100%">
            <div class="card-header bg-dark text-white">
                ...
                <a class="btn btn-success rounded-pill" href="{{ route("log.index") }}">Kembali</a>
                <i class="fa-fw fas fa-history nav-icon" style="margin-left:10px">

                </i> Filter Log Pengadaan
            ...
            <div class="card-body">
                ...
                <div class="data-table-list">
                    <div class="table-responsive">
                        <table id="table_find_log" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>id</th>
                                    <th>Nama Barang</th>
