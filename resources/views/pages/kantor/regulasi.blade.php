                                ...
                                <center>
                                    @role('it|kantor')
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#note{{ $item->id }}"><i class="fa-fw fas fa-pencil-square nav-icon text-white"></i></button>
...
<div class="modal fade" id="note{{ $item->id }}" role="dialog" aria-labelledby="confirmFormLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">
            Catatan Regulasi&nbsp;<span class="pull-right badge badge-info text-white" style="margin-top:5px">ID : {{ $item->id }}</span></b>
          </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body modal-note">
            ...
            <div class="row">
                <div class="col">
                    <button class="btn btn-success pull-right"><i class="fa-fw fas fa-plus nav-icon"></i> Tambah Catatan</button>
                </div>
            </div>
            {!! Form::close() !!}
            <hr>
