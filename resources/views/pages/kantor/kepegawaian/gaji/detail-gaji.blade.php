    ...
    <div class="col-md-4">
        <div class="card" style="width: 100%">
            <div class="card-header bg-secondary">
                <button type="button" class="btn btn-sm btn-dark pull-left" onclick="window.location.href='{{ url('kepegawaian/gaji/final') }}'"><i class="fa-fw fas fa-hand-o-left nav-icon"></i> Kembali</button> 
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                    <tr style="background-color: maroon" class="text-white">
                                                        <th>Kotor</th>
                                                        <th>Rp {{ number_format( $list['show'][0]->total_kotor,2,",",".") }}</th>
                                                    </tr>
                                                    <tr style="background-color: mediumspringgreen">
                                                        <th>Bersih</th>
                                                        <th>Rp {{ number_format( $list['show'][0]->total_bersih,2,",",".") }}</th>
                                                    </tr>
                                            </tbody>
                                        </table>
                                    </div>
