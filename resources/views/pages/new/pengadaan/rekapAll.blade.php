            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="table" class="table table-bordered display" style="font-size: 13px;width: 100%;/* white-space: nowrap;*/ /* word-break: break-word; */">
                  ...
                  @php
                      // $showTotal = array_sum($totalAll);
                      $getTotalAll = App\Models\pengadaan\pengadaan::select('total')
                        ->whereYear('tgl_pengadaan', $list['tahun'])
                        ->whereMonth('tgl_pengadaan', $list['bulan'])
                        ->groupBy('total')
                        ->orderBy('unit','ASC')
                        ->get();
                        // print_r($getTotalAll);
