    ...
    <div class="col-12 col-md-4">
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-sm btn-light" onclick="window.location.href='{{ route('profkpr.index') }}'" style="margin-right: 7px"><i class="fa-fw fas fa-angle-left nav-icon"></i> Kembali</button>
                <h4>Form Tambah</h4>
            </div>
            <div class="card-body">
