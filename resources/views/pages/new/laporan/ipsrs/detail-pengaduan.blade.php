...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            <div class="card-header">
              <button type="button" class="btn btn-light" onclick="window.location.href='{{ url('pengaduan/ipsrs') }}'"><i class="fa-fw fas fa-angle-left nav-icon"></i> Kembali</button>
            </div>
            @if (empty($list['show'][0]->filename_pengaduan))
                <img class="card-img-top img-thumbnail" src="{{ url('img/no_image.jpg') }}" height="300" alt="Foto Pengaduan">
            @else
                <img class="card-img-top img-thumbnail" src="{{ url('storage/'.substr($list['show'][0]->filename_pengaduan,7,1000)) }}" height="300" alt="Foto Pengaduan">
            @endif
                    ...
                    @else
                        <div class="card-body">
                            <div class="row">
                              <div class="col-12">
                                  <center>
                                    <button type="button" class="btn btn-warning text-white" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1"><i class="fa-fw fas fa-plus nav-icon"></i> Catatan</button>
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#selesai{{ $list['show'][0]->id }}"><i class="fa-fw fas fa-thumbs-up nav-icon"></i> Selesai</button>
                                  </center>
                              </div>
                            </div>
                ...
                @else
                    <div class="card-body">
                        <h5 class="text-center">Verifikasi Laporan ini?</h5><hr>
                          <center>
                            <button type="button" class="btn btn-success" value="0" id="btnterima"><i class="fa-fw fas fa-check-square nav-icon"></i> TERIMA</button>
                            <button type="button" class="btn btn-danger" value="0" id="btntolak"><i class="fa-fw fas fa-window-close nav-icon"></i> TOLAK</button>  
                          </center>
                        <div id="terima" hidden>
                            {{ Form::model($list['show'][0], array('route' => array('pengaduan.ipsrs.terima', $list['show'][0]->id), 'method' => 'POST')) }}
                                ...
                                <center><button type="submit" class="btn btn-dark"><i class="fa-fw fas fa-thumbs-up nav-icon"></i> Submit</button></center>
                            {{ Form::close() }}
                        </div>
                        <div id="tolak" hidden>
                            {{ Form::model($list['show'][0], array('route' => array('pengaduan.ipsrs.tolak', $list['show'][0]->id), 'method' => 'POST')) }}
                                ...
                                <center><button type="submit" class="btn btn-dark"><i class="fa-fw fas fa-thumbs-down nav-icon"></i> Submit</button></center>
                            {{ Form::close() }}
                        </div>
                    </div>
                @endif
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
              <h4>Detail Pengaduan <kbd>ID : {{ $list['show'][0]->id }}</kbd></h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header">
              <h4>Detail Dikerjakan <kbd>{{ $list['show'][0]->tgl_dikerjakan }}</kbd></h4>
            </div>
            <div class="card-body">
                <div class="row">
                    @if (!empty($list['show'][0]->tgl_dikerjakan))
