...
@section('content')
<h2 class="section-title">Hai, {{ Auth::show()->name }}</h2>

<div class="row mt-sm-4">
  <div class="col-12 col-md-12 col-lg-12">
    <div class="card profile-widget">
      <div class="profile-widget-header">
        @if (!empty($list['show']->filename))
          ...
          <div class="profile-widget-item">
            ...
            <div class="profile-widget-item-value mb-2">
              <div class="btn-group">
                ...
                @else
                  <button class="btn btn-info" onclick="window.location.href='{{ url('./profil/'.$list['show']->id) }}'"><i class="fas fa-download"></i></button>
                @endif
      ...
      <div class="profile-widget-description">
        <div class="profile-widget-name">{{ Auth::show()->nama }} <div class="text-muted d-inline font-weight-normal">&mdash; @foreach($list['show']->roles()->pluck('name') as $role) <span class="badge badge-light">{{ $role }}</span> @endforeach</div></div>
        {{-- {{ $list['show']->bio }} --}}
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="form-group col-md-7 col-12">
              <label>NIK</label>
              <input type="text" id="nik" name="nik" class="form-control" value="{{ $list['show']->nik }}" autofocus required>
            ...
            <div class="form-group col-md-8 col-12">
              ...
              <input type="text" id="nama" name="nama" class="form-control" value="{{ $list['show']->nama }}" required>
              <div class="invalid-feedback">
            ...
            <div class="form-group col-md-4 col-12">
              ...
              <input type="text" id="nick" name="nick" class="form-control" value="{{ $list['show']->nick }}" required>
              <div class="invalid-feedback">
            ...
            <div class="form-group col-md-3 col-12">
              ...
              <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control" value="<?php echo strftime('%Y-%m-%d', strtotime($list['show']->tgl_lahir)); ?>" required>
              <div class="invalid-feedback">
                Please fill in the email
              </div>
            </div>
          ...
          <div class="row">
            <div class="form-group col-md-6 col-12">
              <label>Email</label>
              <input type="email" id="email" name="email" class="form-control" value="{{ $list['show']->email }}" required>
              <div class="invalid-feedback">
                Please fill in the email
              </div>
            </div>
            <div class="form-group col-md-6 col-12">
              ...
              <input type="text" id="no_hp" name="no_hp" class="form-control" value="{{ $list['show']->no_hp }}" required>
              <div class="invalid-feedback">
                Please fill in the email
              </div>
            </div>
            <div class="form-group col-md-6 col-12">
              ...
              <input type="text" id="ig" name="ig" class="form-control" value="{{ $list['show']->ig }}">
              <div class="invalid-feedback">
                Please fill in the email
              </div>
            </div>
            <div class="form-group col-md-6 col-12">
              ...
              <input type="text" id="fb" name="fb" class="form-control" value="{{ $list['show']->fb }}">
              <div class="invalid-feedback">
                Please fill in the email
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12 col-12">
              ...
              <textarea class="form-control" name="alamat_ktp" id="alamat_ktp" placeholder="" maxlength="190" rows="8" required><?php echo htmlspecialchars($list['show']->alamat_ktp); ?></textarea>
            </div>
            <div class="form-group col-md-12 col-12">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="alamat_dom" id="alamat_dom" placeholder="" maxlength="190" rows="8"><?php echo htmlspecialchars($list['show']->alamat_dom); ?></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <input type="text" id="sd" name="sd" value="{{ $list['show']->sd }}" class="form-control" placeholder="Nama Sekolah Dasar">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_sd" name="th_sd" value="{{ $list['show']->th_sd }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="smp" name="smp" value="{{ $list['show']->smp }}" class="form-control" placeholder="Nama Sekolah Menengah Pertama">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_smp" name="th_smp" value="{{ $list['show']->th_smp }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="sma" name="sma" value="{{ $list['show']->sma }}" class="form-control" placeholder="Nama Sekolah Menengah Atas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_sma" name="th_sma" value="{{ $list['show']->th_sma }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="d1" name="d1" value="{{ $list['show']->d1 }}" class="form-control" placeholder="Nama Universitas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_d1" name="th_d1" value="{{ $list['show']->th_d1 }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="d3" name="s3" value="{{ $list['show']->d3 }}" class="form-control" placeholder="Nama Universitas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_d3" name="th_d3" value="{{ $list['show']->th_d3 }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="s1" name="s1" value="{{ $list['show']->s1 }}" class="form-control" placeholder="Nama Universitas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_s1" name="th_s1" value="{{ $list['show']->th_s1 }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="s2" name="s2" value="{{ $list['show']->s2 }}" class="form-control" placeholder="Nama Universitas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_s2" name="th_s2" value="{{ $list['show']->th_s2 }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-8">
              <input type="text" id="s3" name="s3" value="{{ $list['show']->s3 }}" class="form-control" placeholder="Nama Universitas">
            </div>
            <div class="col-md-3">
              <input type="number" id="th_s3" name="th_s3" value="{{ $list['show']->th_s3 }}" class="form-control" max="9999" placeholder="Tahun Lulus">
            </div>
          </div>
          <hr style="margin-top: 5px">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="pengalaman_kerja" id="pengalaman_kerja" placeholder=""><?php echo htmlspecialchars($list['show']->pengalaman_kerja); ?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <textarea class="form-control" name="riwayat_penyakit_keluarga" id="riwayat_penyakit_keluarga" placeholder=""><?php echo htmlspecialchars($list['show']->riwayat_penyakit_keluarga); ?></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Riwayat Penyakit Keluarga</label>
                <textarea class="form-control" name="riwayat_penyakit" id="riwayat_penyakit" placeholder=""><?php echo htmlspecialchars($list['show']->riwayat_penyakit); ?></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Riwayat Operasi</label>
                <textarea class="form-control" name="riwayat_operasi" id="riwayat_operasi" placeholder=""><?php echo htmlspecialchars($list['show']->riwayat_operasi); ?></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Riwayat Penggunaan Obat</label>
                <textarea class="form-control" name="riwayat_penggunaan_obat" id="riwayat_penggunaan_obat" placeholder=""><?php echo htmlspecialchars($list['show']->riwayat_penggunaan_obat); ?></textarea>
              </div>
            </div>
          </div>
        </div>
