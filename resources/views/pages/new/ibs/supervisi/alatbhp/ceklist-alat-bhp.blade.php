                ...
                <div class="col-md-12">
                    <div class="btn-group" role="group">
                        @role('ibs')
                            ...
                            <button class="btn btn-info" data-toggle="modal" data-target="#readme"><i class="fa-fw fas fa-info nav-icon"></i></button>
                        @endrole
                        @role('karu-ibs')
                    ...
                    <hr>
                    @hasanyrole('karu-ibs|spv')
                        <form class="form-inline" action="{{ route('ibs.supervisi.cari') }}" method="GET">
            ...
            <form class="form-auth-small" action="{{ route('ibs.supervisi.pushtim') }}" method="GET" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label>Shift</label>
                            <select name="shift" class="form-control selectric" id="shift" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <select name="tim[]" class="form-control select2" style="width: 100%" multiple="multiple" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="data-table-list">
                    <div class="table-responsive">
                        <table id="lihatCek" class="table table-bordered display table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
