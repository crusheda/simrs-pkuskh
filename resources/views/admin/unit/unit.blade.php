                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form class="form-auth-small" action="{{ route('admin.unit.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <hr>
                            <label>Kode :</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="ex: bangsal-dewasa">
                            <br>
                            <label>Nama Unit :</label>
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="ex: Bangsal Dewasa">
                            <br>
