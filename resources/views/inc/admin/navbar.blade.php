    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('home') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('img/logo-admin-white.png') }}" alt="">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            {{-- <div class="dropdown d-none d-sm-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img id="header-lang-img" src="admin/images/flags/us.jpg" alt="Header Language" height="16">
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-account-box-outline font-size-16 align-middle me-1"></i> Profil</a>
                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Ubah Password</a>
