<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            <li class="nav-item" style="background-color: #262A2E" onclick="window.location.href='{{ route('profil.index') }}'">
                <a onclick="window.location.href='{{ route('profil.index') }}'" class="nav-link disabled text-white" style="font-size: 15px">
