...
$(function() {
    ...
    function l(a, t) {
        ...
        5 == a ? (e = d.val(),
        l = c.val(),
        "" !== e && "" !== l && ($.fn.dataTableExt.afnFiltering.length = 0,
        n.dataTable().fnDraw(),
        o = a,
        s = e,
        r = l,
        ...
        n.dataTable().fnDraw()) : n.DataTable().column(a).search(t, !1, !0).draw()
    }
    o.length && o.flatpickr({
        ...
        onClose: function(a, t, e) {
            ...
            d.val(l)),
            null != a[1] && (l = moment(a[1]).format("MM/DD/YYYY"),
            c.val(l)),
    ...
    t.length && ($(".dt-column-search thead tr").clone(!0).appendTo(".dt-column-search thead"),
    ...
    e.length && e.DataTable({
        ...
        columnDefs: [{
            ...
            render: function(a, t, e, l) {
                ...
                return void 0 === n[e] ? a : '<span class="badge rounded-pill ' + n[e].class + '">' + n[e].title + "</span>"
            }
        }],
        destroy: !0,
