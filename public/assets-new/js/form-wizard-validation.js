...
!function() {
    ...
    null !== i) {
        ...
        var m = t.querySelector("#personal-info-validation")
          , u = t.querySelector("#social-links-validation");
        const n = [].slice.call(t.querySelectorAll(".btn-next"))
          ...
          , c = (a.length && a.each(function() {
            $(this).selectpicker().on("change", function() {
                d.revalidateField("formValidationLanguage")
            })
        }),
        e.length && e.each(function() {
            ...
            e.select2({
                ...
                d.revalidateField("formValidationCountry")
            })
        }),
