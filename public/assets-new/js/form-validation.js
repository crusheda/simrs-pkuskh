...
document.addEventListener("DOMContentLoaded", function(e) {
    {
        ...
        var n;
        if (flatpickr(a.querySelector('[name="formValidationDob"]'), {
            enableTime: !1,
            dateFormat: "Y/m/d",
            onChange: function() {
        ...
        t.length && (t.wrap('<div class="position-relative"></div>'),
        t.select2({
        ...
        isRtl) {
            const r = [].slice.call(document.querySelectorAll(".typeahead"));
            r && r.forEach(e=>{
