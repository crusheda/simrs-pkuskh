...
$(function() {
    var n, a, e = $(".datatables-basic"), t = $(".dt-complex-header"), s = $(".dt-row-grouping"), l = $(".dt-multilingual"), r = (e.length && (n = e.DataTable({
    ...
    s.length && (a = s.DataTable({
        ...
        drawCallback: function(e) {
            ...
            a.column(2, {
                page: "current"
            }).data().each(function(e, a) {
                s !== e && ($(t).eq(a).before('<tr class="group"><td colspan="8">' + e + "</td></tr>"),
                s = e)
            })
        },
        responsive: {
