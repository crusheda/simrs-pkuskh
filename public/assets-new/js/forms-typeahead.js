      ...
      , e = ($(".typeahead-custom-template").typeahead(null, {
        ...
        templates: {
            ...
            suggestion: function(e) {
                return "<div><strong>" + e.value + "</strong> – " + e.year + "</div>"
            }
        }
    }),
    new Bloodhound({
