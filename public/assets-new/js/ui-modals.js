...
!function() {
    ...
    {
        const n = [].slice.call(document.querySelectorAll('[data-bs-toggle="modal"]'));
        n.map(function(e) {
            e.onclick = function() {
                const e = this.getAttribute("data-bs-target")
                  , t = this.getAttribute("data-theVideo")
                  , a = t + "?autoplay=1"
                  , o = document.querySelector(e + " iframe");
                o && o.setAttribute("src", a)
            }
        })
    }
