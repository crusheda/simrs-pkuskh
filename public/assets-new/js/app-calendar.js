...
document.addEventListener("DOMContentLoaded", function() {
    {
        ...
        var {dayGrid: c, interaction: u, timeGrid: v, list: m} = calendarPlugins;
        let i = new Calendar(f,{
            ...
            dateClick: function(e) {
                ...
                E.innerHTML = "Add",
                E.classList.remove("btn-update-event"),
                E.classList.add("btn-add-event"),
            ...
            eventClick: function(e) {
                ...
                void 0 !== a.extendedProps.location && (A.value = a.extendedProps.location),
                void 0 !== a.extendedProps.guests && P.val(a.extendedProps.guests).trigger("change"),
                void 0 !== a.extendedProps.description && (F.value = a.extendedProps.description)
            },
            datesSet: function() {
                s()
            },
        ...
        H && H.forEach(e=>{
            e.addEventListener("click", ()=>{
                document.querySelectorAll(".input-filter:checked").length < document.querySelectorAll(".input-filter").length ? C.checked = !1 : C.checked = !0,
                i.refetchEvents()
            }
            )
        }
