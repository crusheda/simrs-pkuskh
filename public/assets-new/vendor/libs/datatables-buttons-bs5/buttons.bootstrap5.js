...
*/
      ...
      void 0 === (i = function(t) {
          return function(t, n, e, o) {
              ...
              return t.extend(!0, i.Buttons.defaults, {
                  dom: {
                      container: {
                  ...
                  buttonCreated: function(n, e) {
                      return n.buttons ? t('<div class="btn-group"/>').append(e) : e
                  }
              }),
...
*/
      ...
      void 0 === (i = function(t) {
          return function(t, n, e, o) {
              ...
              i.ext.renderer.pageButton.bootstrap = function(n, s, r, a, u, l) {
                  var c, d, f, p = new i.Api(n), b = n.oClasses, h = n.oLanguage.oPaginate, g = n.oLanguage.oAria.paginate || {}, m = 0, v = function(e, o) {
                      var i, s, a, f, y = function(n) {
                          n.preventDefault(),
                          t(n.currentTarget).hasClass("disabled") || p.page() == n.data.action || p.page(n.data.action).draw("page")
                      };
                      for (i = 0,
                      s = o.length; i < s; i++)
                          if (f = o[i],
                          Array.isArray(f))
                              ...
                              c && (a = t("<li>", {
                                  ...
                                  id: 0 === r && "string" == typeof f ? n.sTableId + "_" + f : null
                              }).append(t("<a>", {
                                  href: "#",
                  ...
                  v(t(s).empty().html('<ul class="pagination"/>').children("ul"), a),
                  f !== o && t(s).find("[data-dt-idx=" + f + "]").trigger("focus")
              }
              ,
              i
          }(t, window, document)
          ...
          return function(t, n, e, o) {
              ...
              t.extend(d.prototype, {
                  ...
                  add: function(t, n) {
                      ...
                      return this._expandButton(e, t, s !== o, n),
                      this._draw(),
                      this
                  },
                  container: function() {
                  ...
                  text: function(n, e) {
                      ...
                      return e === o ? l(i.conf.text) : (i.conf.text = e,
                  ...
                  _expandButton: function(n, e, i, s) {
                      for (var r = this.s.dt, a = Array.isArray(e) ? e : [e], u = 0, l = a.length; u < l; u++) {
                          var c = this._resolveExtends(a[u]);
                          if (c)
                              if (Array.isArray(c))
                                  this._expandButton(n, c, i, s);
                              else {
                                  var d = this._buildButton(c, i);
                                  d && (s !== o && null !== s ? (n.splice(s, 0, d),
                                  s++) : n.push(d),
                                  d.conf.buttons && (d.collection = t("<" + this.c.dom.collection.tag + "/>"),
                                  d.conf._collection = d.collection,
                                  this._expandButton(d.buttons, d.conf.buttons, !0, s)),
                                  c.init && c.init.call(r.button(d.node), r, t(d.node), c))
                              }
                      }
                  },
                  _buildButton: function(n, e) {
                      ...
                      var c = function(n, e, o, i) {
                        ...
                        , p = t("<" + d + "/>").addClass(i.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", (function(t) {
                          t.preventDefault(),
                          !p.hasClass(i.disabled) && n.action && c(t, u, p, n),
                          f && p.trigger("blur")
                      }
                      )).on("keyup.dtb", (function(t) {
                          13 === t.keyCode && !p.hasClass(i.disabled) && n.action && c(t, u, p, n)
                      }
                      ));
                      if ("a" === d.toLowerCase() && p.attr("href", "#"),
                      "button" === d.toLowerCase() && p.attr("type", "button"),
                      s.tag) {
                          var b = t("<" + s.tag + "/>").html(l(n.text)).addClass(s.className);
                      ...
                      var h, g = this.c.dom.buttonContainer;
                      return h = g && g.tag ? t("<" + g.tag + "/>").addClass(g.className).append(p) : p,
                      this._addKey(n),
                  ...
                  _resolveExtends: function(n) {
                      var e, i, s = this.s.dt, r = function(e) {
                      ...
                      for (n = r(n); n && n.extend; ) {
                          ...
                          var l = u.className;
                          n = t.extend({}, u, n),
                          l && n.className !== l && (n.className = l + " " + n.className);
                  ...
                  _popover: function(o, i, s) {
                      var r = i
                        ...
                        , p = function() {
                          ...
                          t(r.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr("aria-expanded", "false"),
                      ...
                      !1 === o && p();
                      var b = t(r.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes());
                      b.length && (f = b.eq(0),
                      p());
                      var h = t("<div/>").addClass("dt-button-collection").addClass(c.collectionLayout).css("display", "none");
                      o = t(o).addClass(c.contentClassName).attr("role", "menu").appendTo(h),
                      f.attr("aria-expanded", "true"),
                      f.parents("body")[0] !== e.body && (f = e.body.lastChild),
                      c.collectionTitle && h.prepend('<div class="">' + c.collectionTitle + "</div>"),
                      u(h.insertAfter(f), c.fade);
                      var g = t(i.table().container())
                        , m = h.css("position");
                      if ("dt-container" === c.align && (f = f.parent(),
                      h.css("width", g.width())),
                      "absolute" === m) {
                          var v = f.position()
                            , y = t(i.node()).position();
                          ...
                          var N = g.offset().left
                            ...
                            , P = f.offset().left
                            , S = P + f.outerWidth();
                          if (h.hasClass(c.rightAlignClassName) || h.hasClass(c.leftAlignClassName) || "dt-container" === c.align) {
                              var O, K, j = 0;
                              h.hasClass(c.rightAlignClassName) ? N > H + (j = S - L) && (j += (O = N - (H + j)) > (K = B - (L + j)) ? K : O) : B < L + (j = N - H) && (j += (O = N - (H + j)) > (K = B - (L + j)) ? K : O),
                          ...
                          (D = h.height() / 2) > t(n).height() / 2 && (D = t(n).height() / 2),
                          h.css("marginTop", -1 * D);
                      ...
                      t("body").on("click.dtb-collection", (function(n) {
                          ...
                          (!t(n.target).parents()[e]().filter(o).length && !t(i).hasClass("dt-buttons") || t(n.target).hasClass("dt-button-background")) && p()
                      }
                      ...
                      c.autoClose && setTimeout((function() {
                          r.on("buttons-action.b-internal", (function(t, n, e, o) {
                              o[0] !== f[0] && p()
                          }
                          ))
                      }
              ...
              d.background = function(n, i, s, r) {
                  s === o && (s = 400),
                  r || (r = e.body),
                  n ? u(t("<div/>").addClass(i).css("display", "none").insertAfter(r), s) : l(t("div." + i), s, (function() {
                  ...
                  var i = []
                    ...
                    , r = function(n) {
                      if (Array.isArray(n))
                          ...
                          "number" == typeof n && i.push(e[n].inst)
                  };
                  return r(n),
                  i
              }
              ...
              i.Api.register("button().add()", (function(t, n) {
                  var e = this.context;
                  if (e.length) {
                      var o = d.instanceSelector(this._groupSelector, e[0]._buttons);
              ...
              i.Api.register("buttons.info()", (function(n, e, i) {
                  ...
                  n = n ? "<h2>" + n + "</h2>" : "",
                  u(t('<div id="datatables_buttons_info" class="dt-button-info"/>').html(n).append(t("<div/>")["string" == typeof e ? "html" : "append"](e)).css("display", "none").appendTo("body")),
              ...
              var f = function(n) {
                ...
                , m = function(n, e) {
                  ...
                  for (var u = n.rows(i.rows, a).indexes().toArray(), l = n.cells(u, i.columns), c = l.render(i.orthogonal).toArray(), f = l.nodes().toArray(), p = s.length, b = [], h = 0, g = 0, m = p > 0 ? c.length / p : 0; g < m; g++) {
                      for (var v = [p], y = 0; y < p; y++)
                          v[y] = i.format.body(c[h], g, y, f[h]),
                          h++;
                      b[g] = v
                  }
                  var x = {
