!function(e, t) {
  ...
  488: function(e, t, n) {
      ...
      function A(e, t, n) {
          for (var o in t)
              o in e ? "string" == typeof e[o] || e[o]instanceof String || "string" == typeof t[o] || t[o]instanceof String ? n && (e[o] = t[o]) : A(e[o], t[o], n) : e[o] = t[o];
          return e
      }
      function I(e) {
          return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
        ...
        , q = function(e) {
          ...
          u(t, [{
              ...
              value: function(e, t) {
                  ...
                  if (k && h && x && m.indexOf(y) < 0 && ("string" != typeof b || "[object Array]" !== y)) {
                  ...
                  } else if (k && "string" == typeof b && "[object Array]" === y)
                      ...
                      if (j || R || N) {
                          ...
                          var A = function(e, o) {
                              n.options.missingKeyHandler ? n.options.missingKeyHandler(e, l, o, N ? t.defaultValue : h, N, t) : n.backendConnector && n.backendConnector.saveMissing && n.backendConnector.saveMissing(e, l, o, N ? t.defaultValue : h, N, t),
                  ...
                  e.forEach((function(e) {
                      if (!a.isValidLookup(t)) {
                          ...
                          c.forEach((function(e) {
                              ...
                              !_["".concat(g[0], "-").concat(e)] && a.utils && a.utils.hasLoadedNamespace && !a.utils.hasLoadedNamespace(i) && (_["".concat(g[0], "-").concat(e)] = !0,
                              a.logger.warn('key "'.concat(n, '" for namespace "').concat(i, '" for languages "').concat(g.join(", "), "\" won't get resolved as namespace was not yet loaded"), "This means something IS WRONG in your application setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")),
      ...
      var X = function() {
        ...
        , J = function() {
          ...
          return u(e, [{
                  ...
                  for (a = 0; r = this.regexpUnescape.exec(e); ) {
                      if (void 0 === (i = c(r[1].trim())))
                          if ("function" == typeof f) {
                              ...
                              this.logger.warn("missed to pass in variable ".concat(r[1], " for interpolating ").concat(e)),
                              i = "";
                      else
                          "string" == typeof i || this.useRawValueToEscape || (i = j(i));
                      if (e = e.replace(r[0], l(i)),
              ...
              key: "nest",
              value: function(e, t) {
                  var n, o, r = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, s = i({}, a);
                  function u(e, t) {
                  ...
                  delete s.defaultValue; n = this.nestingRegexp.exec(e); ) {
                      ...
                      if ((o = t(u.call(this, n[1].trim(), s), s)) && n[0] === e && "string" != typeof o)
                          return o;
      ...
      var ee = new (function(e) {
          ...
          u(t, [{
              ...
              value: function() {
                  ...
                  t = {}),
                  this.options = i({}, Y(), this.options, Q(t)),
                  ...
                  !this.options.isClone) {
                      ...
                      this.modules.languageDetector && (a.languageDetector = o(this.modules.languageDetector),
                      a.languageDetector.init(a, this.options.detection, this.options)),
                      this.modules.i18nFormat && (a.i18nFormat = o(this.modules.i18nFormat),
      ...
      function ae(e, t, n, r, i) {
          r && "object" === o(r) && (i || (r._t = new Date),
          r = ie("", r).slice(1)),
          t.queryStringParams && (e = ie(e, t.queryStringParams));
          try {
              var a;
      ...
      var ue = function() {
          ...
          return u(e, [{
              ...
              value: function(e) {
                  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                  this.services = e,
                  this.options = re(t, this.options || {}, se())
              }
          }, {
              key: "readMulti",
              value: function(e, t, n) {
              ...
              value: function(e, t, n, o) {
                  ...
                  e.forEach((function(e) {
                      ...
                      r.options.ajax(n, r.options, (function(e, t) {}
                      ), i)
                  }
                  ))
              }
      ...
      var he, de = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, ve = function(e, t, n) {
          ...
          o && (r.domain = o),
          document.cookie = ve(e, encodeURIComponent(t), r)
      }, me = function(e) {
          ...
          lookup: function(e) {
              ...
              if ("undefined" != typeof window)
                  for (var n = window.location.search.substring(1).split("&"), o = 0; o < n.length; o++) {
                      var r = n[o].indexOf("=");
                      if (r > 0)
                          n[o].substring(0, r) === e.lookupQuerystring && (t = n[o].substring(r + 1))
                  }
              return t
          }
      };
